...
// Partial is needed to avoid having to specify undefined everywhere
export type TBranchPRInfo = Partial<t.TypeOf<typeof prInfoSchema>>;
...
// Partial is needed to avoid having to specify undefined everywhere
export type TMeta = Partial<t.TypeOf<typeof metaSchema>>;
...
export function readMetadataRef(branchName: string, cwd?: string): TMeta {
  ...
  try {
    ...
    return {
      ...
      parentBranchRevision: undefined,
      prInfo: undefined,
    };
  }
}
